...
public class PrimeNumberServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session=request.getSession(true);//ถ้าส่ง parameterเป็น true ถ้าไม่มีsessionมันจะ create ให้ ถ้าเป็น false มันจะไม่ create ให้เเต่จะส่ง reerence มา
                                                     //ถ้าใส่ส่งมันจะเป็น true โดยอัตโนมัติ
        String n=request.getParameter("number");     //number ชื่อตัวเเปรที่ส่งมา
        if(n!=null){
